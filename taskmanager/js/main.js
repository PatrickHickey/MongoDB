...
function addTask(e){
  ...
  $.ajax({
    url: 'https://api.mlab.com/api/1/databases/taskmanager_test/collections/tasks?apiKey='+apiKey,
    data: JSON.stringify({
      "task_name": task_name,
      "category": category,
      "due_date": due_date,
...
function getTask(id){
  $.get('https://api.mlab.com/api/1/databases/taskmanager_test/collections/tasks/'+id+'?apiKey='+apiKey, function(task){
...
function editTask(e){
  ...
  $.ajax({
    url: 'https://api.mlab.com/api/1/databases/taskmanager_test/collections/tasks/'+task_id+'?apiKey='+apiKey,
    data: JSON.stringify({
      "task_name": task_name,
      "category": category,
      "due_date": due_date,
...
function addCategory(e){
  ...
  $.ajax({
    url: 'https://api.mlab.com/api/1/databases/taskmanager_test/collections/categories?apiKey='+apiKey,
    data: JSON.stringify({
...
function getCategory(id){
  $.get('https://api.mlab.com/api/1/databases/taskmanager_test/collections/categories/'+id+'?apiKey='+apiKey, function(category){
...
function editCategory(e){
  ...
  var category_name = $('#category_name').val();
  $.ajax({
    url: 'https://api.mlab.com/api/1/databases/taskmanager_test/collections/categories/'+category_id+'?apiKey='+apiKey,
    data: JSON.stringify({
      "category_name": category_name
    }),
    type:'PUT',
